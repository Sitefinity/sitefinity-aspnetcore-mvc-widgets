namespace Progress.Sitefinity.AspNetCore.Widgets.Models.Facets
{
    internal static class SearchFacetExtensions
    {
        ...
        /// <returns>Returns true if the facet is of a type value and false if the facet is a range or interval.</returns>
        internal static bool IsValueFacet(this Settings settings)
        {
            if (settings.RangeType == AutoGeneratedFacet)
            {
