...
namespace Progress.Sitefinity.AspNetCore.Widgets.Models.Facets
{
    ...
    public class Settings
    {
        ...
        /// <summary>
        /// Gets or sets the whole number ranges.
        /// </summary>
        [TableView(Reorderable = false, Selectable = false, MultipleSelect = false)]
        [DisplayName("Set ranges")]
        [Description("Specify the ranges for generating facets.")]
        ...
        public IList<NumberRange> NumberRanges { get; set; }

        /// <summary>
        /// Gets or sets the decimal number ranges.
        /// </summary>
        [TableView(Reorderable = false, Selectable = false, MultipleSelect = false)]
        [DisplayName("Set ranges")]
        [Description("Specify the ranges for generating facets.")]
        ...
        public IList<DecimalNumberRange> NumberRangesDecimal { get; set; }
        ...
        public bool DisplayCustomRange { get; set; }

        /// <summary>
        /// Gets or sets the field of the facet.
        /// </summary>
