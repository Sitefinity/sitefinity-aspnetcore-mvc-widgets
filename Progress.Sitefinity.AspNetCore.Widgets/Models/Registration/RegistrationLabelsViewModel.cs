namespace Progress.Sitefinity.AspNetCore.Widgets.Models.Registration
{
    ...
    /// Labels view model.
    /// </summary>
    public class RegistrationLabelsViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the repeat password label.
        /// </summary>
        public string RepeatPasswordLabel { get; set; }

        /// <summary>
        /// Gets or sets the secret question label.
        /// </summary>
        public string SecretQuestionLabel { get; set; }

        /// <summary>
        /// Gets or sets the secret answer label.
        /// </summary>
        public string SecretAnswerLabel { get; set; }

        /// <summary>
        /// Gets or sets the register button label.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the invalid email message.
        /// </summary>
