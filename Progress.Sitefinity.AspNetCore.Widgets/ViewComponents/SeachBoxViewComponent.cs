...
namespace Progress.Sitefinity.AspNetCore.Widgets.ViewComponents
{
    ...
    /// </summary>
    [SitefinityWidget(Title = "Search box", Order = 2, Section = WidgetSection.NavigationAndSearch, EmptyIconText = "Set where to search", EmptyIconAction = EmptyLinkAction.Edit, EmptyIcon = "search", Category = WidgetCategory.Content, IconName = "search")]
