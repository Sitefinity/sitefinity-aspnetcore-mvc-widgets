...
namespace Progress.Sitefinity.AspNetCore.Widgets.ViewComponents
{
    ...
    /// </summary>
    [SitefinityWidget(Title = ContentListViewComponent.Title, SeparateWidgetPerTemplate = true, EmptyIconText = "Select content", EmptyIconAction = EmptyLinkAction.Edit, EmptyIcon = "plus-circle", Section = WidgetSection.ContentLists)]
